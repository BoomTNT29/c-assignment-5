...
string Zoo_species::get_name() { return this->Species_name; }

int Zoo_species::get_count() { return this->Species_count; }

Mammal::Mammal(string name, int count, diet_type dt)
    : Zoo_species(name, count), Diet_type{dt} {
  // do something
}
...
Reptile::Reptile(string name, int count, feed_size fs)
    : Zoo_species(name, count), Feed_size(fs) {
  // do nothing
}
...
Bird::Bird(string name, int count, bird_feed bf)
    : Zoo_species(name, count), Bird_feed{bf} {
  // do nothing
}
...
Aquatic::Aquatic(string name, int count, aqua_feed af)
    : Zoo_species(name, count), Aqua_feed{af} {
  // do nothing
}
